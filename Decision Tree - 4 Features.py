...
raw = raw[['dti','fico_range_low','term','int_rate','loan_status']]
raw.columns = ['f1','f2','f3','f4','target']
...
# plt.xlabel('DTI Ratio Threshold', fontsize=12)
...
def node(prev,curr):
        ...
        if prev[-1] in prune:
            ...
            if obs <= 1000:
                ...
                dic = {info_gain_f1[0]:"f1",info_gain_f2[0]:"f2",info_gain_f3[0]:"f3",info_gain_f4[0]:"f4"}
                node = dic.get(max(dic))
                dic2 = {'f1':info_gain_f1[1],'f2':info_gain_f2[1],'f3':info_gain_f3[1],'f4':info_gain_f4[1]}
