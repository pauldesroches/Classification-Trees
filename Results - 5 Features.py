...
val.columns = ['f1','f2','f3','f4','f5','target']
...
for row in list(range(0,obs)):
    if ((val.f5[row] > 13.62) & (val.f1[row] > 20.1)) or ((val.f5[row] > 13.62) & (val.f1[row] <= 20.1) & (val.f4[row] == 1)) or ((val.f5[row] > 13.62) & (val.f1[row] <= 20.1) & (val.f4[row] == 0) & (val.f3[row] <= 200)) or ((val.f5[row] <= 13.62) & (val.f2[row] <= 715) & (val.f3[row] <= 56) & (val.f1[row] > 23.35)):
